...
macro(get_library_name LIB_NAME OUTPUT_NAME)
    ...
    if(MSVC)
        ...
        # Generate the lib name in enhanced list format "optimised;xxx;debug;xxx".
        # FIndBoost generates lib names in this format, and UseSwig requires it.
        set(LIB_FULL_NAME "${LIB_NAME}${LIB_PLATFORM}${LIB_THREAD_OPT}${LIB_RT_OPT}")
        set(OUTPUT_NAME "optimized;${LIB_FULL_NAME};debug;${LIB_FULL_NAME}${CMAKE_DEBUG_POSTFIX}")
    else()
