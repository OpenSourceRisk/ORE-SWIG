...
class CDSVolatilityCurveSpec  : public CurveSpec {
    public:
        CDSVolatilityCurveSpec(const std::strinf& curveConfigID);
...
class BaseCorrelationCurveSpec  : public CurveSpec {
    public:
        BaseCorrelationCurveSpec(const std::strinf& curveConfigID);
...
class YieldVolatilityCurveSpec  : public CurveSpec {
    public:
        YieldVolatilityCurveSpec(const std::strinf& curveConfigID);
...
class FXVolatilityCurveSpec  : public CurveSpec {
    public:
        FXVolatilityCurveSpec(std::string unitCcy, std::string ccy, const std::string& curveConfigID)
